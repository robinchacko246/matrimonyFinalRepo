  ...
  getUser: async data => {
    ...
    if (user.match(/@/)) {
      ...
      if (result != "") {
        ...
        if (result[0]["status"] == 0) return { error: "varification already sent to your mail ..please check and varify" };
        // if (result[0]["status"] == 1 && result[0]["is_approved"]==0) return { error: "please wait admin validating your details" };
