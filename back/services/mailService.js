...
module.exports = {
  registerMail: (mail, username, link) => {
    ...
    var message=`<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"><html data-editor-version="2" class="sg-campaigns" xmlns="http://www.w3.org/1999/xhtml"><head>
...
<![endif]-->
  ...
  <tbody>
    <tr>
      <td style="font-size:18px; line-height:10px; padding:0px 0px 0px 0px;" valign="top" align="center">
           <b >MarryHoly</b>
      </td>
    </tr>
  </tbody>
  ...
  <tbody>
    <tr>
      <td style="padding:50px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 23px">Varify Your Account!&nbsp;</span></div><div></div></div></td>
    </tr>
  </tbody>
</table><table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="a10dcb57-ad22-4f4d-b765-1d427dfddb4e" data-mc-module-version="2019-10-22">
  <tbody>
    <tr>
      <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 18px"><p>Hi ` +
      username +
      `,</p>
      
       
          <br>
          <p>We have received your registration on MarryHoly.</p>
          <p>We hope you will find what you are looking for on our platform.</p>
          <p>To get started on MarryHoly, please make sure to validate the following link:
        
        <br>
        <p>See you soon on MarryHoly.</p></span><span style="font-size: 18px">.</span></div>
...
<div style="font-family: inherit; text-align: center"><span style="color: #ffffff; font-size: 18px">1. Update your profile  with attractive profile photo .</span></div>
<div style="font-family: inherit; text-align: center"><br></div>
<div style="font-family: inherit; text-align: center"><span style="color: #ffffff; font-size: 18px">2. click on Connect button on Bride/Groom's profile if you want to marry.</span></div>
<div style="font-family: inherit; text-align: center"><br></div>
...
let transporter = nodemailer.createTransport({
  service: 'Gmail',
auth: {
    user: 'robinchacko246@gmail.com',
    pass: 'lrutdyksbinqnbgm'
}
});
transporter.sendMail(
  {
    from: "noreply@MarryHoly.com",
    to: mail,
    subject: "MarryHoly - Reset password",
    html: message,
...
<![endif]-->
  ...
  <tbody>
    <tr>
      <td style="padding:50px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 23px">Reset Your Password!&nbsp;</span></div><div></div></div></td>
    </tr>
  </tbody>
</table><table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="a10dcb57-ad22-4f4d-b765-1d427dfddb4e" data-mc-module-version="2019-10-22">
  <tbody>
    <tr>
      ...
      `,</p>
        <br>
        <p>We have received your password reset request on MarryHoly.</p>
