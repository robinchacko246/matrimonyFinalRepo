  ...
  render() {
    ...
    const LoggedInLinks = () => {
      ...
      const sideList = (side, listNotif) => (
        ...
        >
          <h5 style={{ textAlign: "center", color: "#17cdb6" }}>
            Notifications
          </h5>
          <List>
            {listNotif.length < 1 ? (
    ...
    function LoggedOutLinks() {
      return (
        <ul className="right hide-on-med-and-down">
          ...
          <li>
            <NavLink to="/users/register" className="btn">Register</NavLink>
          </li>
          <li>
            <NavLink to="/users/login" className="btn" >Log in</NavLink>
          </li>
    ...
    const MobileLoggedInLinks = () => {
      ...
      const MobileMenuLogged = menu => (
        ...
        >
          <h5 style={{ textAlign: "center", color: "#17cdb6" }}>Menu</h5>
          <List>
            <ListItem>
